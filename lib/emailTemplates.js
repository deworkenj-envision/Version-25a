          ...
          <tr>
            <td align="center">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:680px;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 10px 30px rgba(15,23,42,0.08);">
                <tr>
                  <td style="background:linear-gradient(90deg,#1d4ed8 0%,#0ea5e9 100%);padding:22px 32px 18px;color:#ffffff;text-align:center;">
                    <div style="margin:0 0 8px 0;text-align:center;line-height:0;">
                      <img
                        src="${LOGO_URL}"
                        alt="EnVision Direct"
                        width="300"
                    ...
                    <div style="font-size:22px;line-height:1.25;font-weight:800;text-align:center;margin:0;">
...
export function buildOrderConfirmationEmail({
  ...
  const html = baseLayout({
    ...
    contentHtml: `
      <h1 style="margin:0 0 10px;font-size:28px;line-height:1.2;color:#0f172a;">Order Confirmed</h1>
...
export function buildShippedEmail({
  ...
  const html = baseLayout({
    ...
    contentHtml: `
      <h1 style="margin:0 0 10px;font-size:28px;line-height:1.2;color:#0f172a;">Your Order Has Shipped</h1>
      <p style="margin:0 0 22px;font-size:16px;line-height:1.7;color:#334155;">
...
export function buildDeliveredEmail({
  ...
  const html = baseLayout({
    ...
    contentHtml: `
      <h1 style="margin:0 0 10px;font-size:28px;line-height:1.2;color:#0f172a;">Your Order Was Delivered</h1>
      <p style="margin:0 0 22px;font-size:16px;line-height:1.7;color:#334155;">
