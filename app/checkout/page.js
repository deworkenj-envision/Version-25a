          ...
          <aside className="space-y-6 lg:sticky lg:top-6 lg:self-start">
            <div className="h-fit rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-5 rounded-xl border border-slate-200 bg-slate-50 p-4">
                <h3 className="text-sm font-bold text-slate-900">Order Details</h3>
                <div className="mt-3 space-y-2 text-sm">
                  <DetailRow label="Product" value={productName} />
                  <DetailRow label="Size" value={size} />
                  <DetailRow label="Paper" value={paper} />
                  <DetailRow label="Finish" value={finish} />
                  <DetailRow label="Sides" value={sides} />
                  <DetailRow label="Quantity" value={quantity} />
                </div>
              </div>

              <div className="mt-5 rounded-xl border border-slate-200 bg-slate-50 p-4">
                <h3 className="text-sm font-bold text-slate-900">Artwork</h3>
                ...
                {artworkUrl ? (
                  ...
                  <p className="mt-3 text-sm font-semibold text-red-600">
                    Artwork missing. Please go back and upload your artwork.
                  </p>
                )}
              </div>
