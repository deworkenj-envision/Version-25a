      ...
      <section className="bg-[#f5f5f7]">
        <div className="mx-auto max-w-7xl px-6 py-16 md:px-10">
          ...
          <div className="mt-12 text-center">
            <Link
              href="/order"
              className="inline-flex items-center justify-center rounded-2xl bg-blue-600 px-8 py-4 text-lg font-bold text-white shadow-lg transition hover:bg-blue-700"
            >
              Start Your Order
            </Link>
          </div>
