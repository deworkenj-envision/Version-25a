              ...
              <div className="space-y-6">
                ...
                <div className="rounded-2xl border border-slate-200 p-5">
                  ...
                  <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                    <Step label="Order Received" done={timeline.pending} active={!timeline.pending} />
                    <Step label="In Production" done={timeline.printing} active={currentStatus === "printing"} />
                    <Step label="Shipped" done={timeline.shipped} active={currentStatus === "shipped"} />
                    <Step label="Delivered" done={timeline.delivered} active={currentStatus === "delivered"} />
                  </div>
                </div>
